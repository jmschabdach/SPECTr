...
python generate_background_noise.py -i sandbox/base_image_sequence.nii.gz -o sandbox/image_sequence_noisy.nii.gz 

# Step 6: Use the DMN ROIs to generate pseudo BOLD signal for the whole sequence. 

python generate_BOLD_signal.py -i sandbox/image_sequence_noisy.nii.gz -r sandbox/masked_dmn_roi.nii.gz -o sandbox/image_sequence_bold.nii.gz
...
python add_motion.py -i sandbox/image_sequence_bold.nii.gz -o sandbox/pseudo_BOLD.nii.gz
